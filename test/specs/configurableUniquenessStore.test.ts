...
describe('ConfigurableUniquenessStore', (): void => {
    ...
    describe('with unique = false', (): void => {
        ...
        it('should add unique values', (): void => {
